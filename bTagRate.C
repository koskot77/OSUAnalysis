...
//sprintf(buff,"(otherTRIGs&1024) && ((selection&31)==31 && thirdJetPtRec>40 && forthJetPtRec<35 && metPtRec>0)*weight");
...
TFile *out = new TFile("bTagRateHists4jetsHT550.root","RECREATE");
//probB_pT->Write();
//probB_eta->Write();
//probB_2d->Write();
norm->Write();
