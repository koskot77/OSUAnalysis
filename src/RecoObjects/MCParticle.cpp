...
MCParticle::MCParticle() : Particle(),
	particlePdgId(0), particleMotherIndex(0), 
        particleMotherId(0), particleGrandMotherId(0), particleStatus(0){
...
int MCParticle::motherId() const {
	return particleMotherId;
}

int MCParticle::grandMotherId() const {
	return particleGrandMotherId;
}
...
void MCParticle::setMotherId(int motherId){
	particleMotherId = motherId;
}

void MCParticle::setGrandMotherId(int grandMotherId){
	particleGrandMotherId = grandMotherId;
}
